...
public class TimedTask {
    ...
    public void initTask() {
        log.info("Configured Provider: {}, Bucket: {}, StorageClass: {}, Crc32cBufferSize: {}",
                applicationProperties.getCloudProviderConfig().getType(),
                applicationProperties.getCloudProviderConfig().getBucketName(),
                applicationProperties.getCloudProviderConfig().getStorageClass(),
                applicationProperties.getCrc32cBufferSize());
        applicationProperties.getScanFolders().stream()
                .forEach(this::logFolderConfig);
    }

    @Autowired
    public TimedTask(SyncFacadeService syncFacadeService, ApplicationProperties applicationProperties,
    ...
    public void performScheduledBackup() {
        ...
        syncFacadeService.startAllLocationSyncs();
    }
