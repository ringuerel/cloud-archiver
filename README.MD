...
A new endpoint is available to trigger the download:
...
```json
{
  "cloudPath": "/home/user/test2/Authelia123.md"
}
```

The file will be restored to a path like:
```
/home/user/downloads/test2/Authelia123.md
```
